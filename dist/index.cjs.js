...
var Icon$1i = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 256 256" }, props),
        React__default['default'].createElement("image", { width: "256px", height: "256px", href: "/images/custom/logo.png" })));
};
...
var Logo$2 = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 309 90" }, props),
        React__default['default'].createElement("image", { width: "309px", height: "90px", href: "/images/custom/site-logo.png" })));
};
...
var Icon$_ = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 260 260" }, props),
        React__default['default'].createElement("circle", { cx: "130", cy: "130", r: "130", fill: "url(#paint0_linear_pancakeround)" }),
        React__default['default'].createElement("image", { width: "256px", height: "256px", href: "/images/custom/token-logo.png" })));
};
...
var CakePrice = function (_a) {
    var cakePriceUsd = _a.cakePriceUsd, _b = _a.color, color = _b === void 0 ? "text" : _b;
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://dex.unsea.io/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82", target: "_blank" },
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#6a83ff", background: "#290538", backgroundDisabled: "#3c2640", 
    // backgroundAlt: "#27262c",
    backgroundAlt: "#412047b5", backgroundAlt2: "rgba(39, 38, 44, 0.7)", 
    // cardBorder: "#383241",
    cardBorder: "#8416a3", contrast: "#FFFFFF", dropdown: "#26102cc2", dropdownDeep: "#100C18", invertedContrast: "#34123ee6", input: "#280726ab", inputSecondary: "#1f0a20", primaryDark: "#0098A1", tertiary: "#5e2339", text: "#FFFFFF", textDisabled: "#837c95", textSubtle: "#c0c0c0", disabled: "#524B63", gradients: {
...
var StyledSubMenuItems = styled__default['default'](Flex)(templateObject_1$n || (templateObject_1$n = __makeTemplateObject(["\n  ", " {\n    ", ";\n  }\n  flex-grow: 1;\n  background: ", ";\n  box-shadow: inset 0px -2px 0px -8px rgba(133, 133, 133, 0.1);\n  overflow-x: scroll;\n  scrollbar-width: none;\n  -ms-overflow-style: none;\n  &::-webkit-scrollbar {\n    display: none;\n  }\n"], ["\n  ", " {\n    ", ";\n  }\n  flex-grow: 1;\n  background: ", ";\n  box-shadow: inset 0px -2px 0px -8px rgba(133, 133, 133, 0.1);\n  overflow-x: scroll;\n  scrollbar-width: none;\n  -ms-overflow-style: none;\n  &::-webkit-scrollbar {\n    display: none;\n  }\n"])), function (_a) {
    ...
    var theme = _a.theme;
    return "" + theme.colors.gradients.subtine;
});
...
var ModalHeader = styled__default['default'].div(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["\n  align-items: center;\n  background: ", ";\n  border-bottom: 1px solid ", ";\n  display: flex;\n  padding: 12px 24px;\n"], ["\n  align-items: center;\n  background: ", ";\n  border-bottom: 1px solid ", ";\n  display: flex;\n  padding: 12px 24px;\n"])), function (_a) {
    ...
    return background || theme.colors.gradients.cardHeader;
}, function (_a) {
    var theme = _a.theme;
    return theme.colors.cardBorder;
});
...
var StyledIconContainer$1 = styled__default['default'].div(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["\n  background: ", ";\n"], ["\n  background: ",
    ";\n"])), function (_a) {
...
var AnimatedIconComponent = function (_a) {
    ...
    return IconElement ? (React__default['default'].createElement(StyledAnimatedIconComponent, __assign({ isActive: isActive, hasFillIcon: hasFillIcon }, props),
        React__default['default'].createElement(StyledIconContainer$1, { activeBackgroundColor: activeBackgroundColor },
            React__default['default'].createElement(IconElement, { color: color })),
        hasFillIcon && (React__default['default'].createElement(StyledIconContainer$1, __assign({ activeBackgroundColor: activeBackgroundColor }, props),
...
var StyledPolicyItem = styled__default['default'].a(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  font-size: 12px;\n  color: ", ";\n  text-align: center;\n  padding-left: 8px;\n  padding-right: 8px;\n  margin-top: 16px;\n\n  &:not(:first-of-type) {\n    border-left: 1px solid ", ";\n  }\n\n  ", " {\n    margin-top: 0px;\n    font-size: 14px;\n  }\n"], ["\n  font-size: 12px;\n  color: ", ";\n  text-align: center;\n  padding-left: 8px;\n  padding-right: 8px;\n  margin-top: 16px;\n\n  &:not(:first-of-type) {\n    border-left: 1px solid ", ";\n  }\n\n  ", " {\n    margin-top: 0px;\n    font-size: 14px;\n  }\n"])), darkColors.text, darkColors.textSubtle, function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
var StyledIconContainer = styled__default['default'](Flex)(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  flex-direction: column;\n  align-items: center;\n  margin-bottom: 40px;\n"], ["\n  flex-direction: column;\n  align-items: center;\n  margin-bottom: 40px;\n"])));
styled__default['default'](Flex)(templateObject_6$1 || (templateObject_6$1 = __makeTemplateObject(["\n  border-color: ", ";\n  border-top-width: 1px;\n  border-bottom-width: 1px;\n  border-style: solid;\n  padding: 24px 0;\n  margin-bottom: 24px;\n\n  ", " {\n    border-top-width: 0;\n    border-bottom-width: 0;\n    padding: 0 0;\n    margin-bottom: 0;\n  }\n"], ["\n  border-color: ", ";\n  border-top-width: 1px;\n  border-bottom-width: 1px;\n  border-style: solid;\n  padding: 24px 0;\n  margin-bottom: 24px;\n\n  ", " {\n    border-top-width: 0;\n    border-bottom-width: 0;\n    padding: 0 0;\n    margin-bottom: 0;\n  }\n"])), darkColors.cardBorder, function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
...
var MenuItem = function (_a) {
    ...
    return (React__default['default'].createElement(StyledFooter, __assign({ p: ["40px 16px", null, "56px 40px 32px 40px"] }, props, { justifyContent: "center" }),
        React__default['default'].createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            React__default['default'].createElement(Flex, { flexDirection: ["column", null, null, "row"], justifyContent: "space-between", alignItems: ["center", null, null, "flex-start"], mb: "42px" },
                React__default['default'].createElement(StyledIconContainer, { flex: "1" },
                    React__default['default'].createElement(LogoWithTextIcon, { isDark: true, width: "230px" }),
                    React__default['default'].createElement(Text, { color: "text", fontSize: "26px", bold: true, mb: "20px", mt: "20px" }, "Utility NFT Coin"),
                    React__default['default'].createElement(StyledSocialLinks, null)),
                React__default['default'].createElement(Flex, { flexDirection: ["column", "row", "row", "row"], justifyContent: "space-around", alignItems: "center", width: "100%", flex: "2" }, items === null || items === void 0 ? void 0 : items.map(function (item) {
                    var _a;
...
var StyledNav = styled__default['default'].nav(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  width: 100%;\n  height: ", "px;\n  background: ", ";\n  border-bottom: 1px solid ", ";\n  transform: translate3d(0, 0, 0);\n\n  padding-left: 16px;\n  padding-right: 16px;\n"], ["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  width: 100%;\n  height: ", "px;\n  background: ", ";\n  border-bottom: 1px solid ", ";\n  transform: translate3d(0, 0, 0);\n\n  padding-left: 16px;\n  padding-right: 16px;\n"])), MENU_HEIGHT, function (_a) {
    var theme = _a.theme;
    return theme.colors.gradients.special;
}, function (_a) {
    var theme = _a.theme;
    return theme.colors.cardBorder;
});
